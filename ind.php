...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <script>
        function alll()
        {
            window.alert("Please log in or sign up first!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1");
        };
    </script>
		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
			 <div class="container">
				<div class="navbar-header">
					...
					<h1 style="margin-top:-20px"><a class="navbar-brand" href="in.html" data-0="line-height:90px;" data-300="line-height:50px;">Go Detection
					</a></h1>
				</div>
				<div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
                        <li class="active"><a href="in.html">Home</a></li>
    ...
    best result. This system can be useful for web crawlers and for web users.
		...
		<section id="section-works" class="section appear clearfix">
            <div class="container" >
                ...
                <div class="container">
                    <textarea style="width:1100px; height:250px" maxlength="150">  </textarea>
                </div>
                <br />
                <div class="container">
                    <center>
  ...
  border: none;
  width:180px;
 box-shadow: 0 9px #999;" type="submit" onclick="alll()">
                            Detect
                        </button>
                    </center>
                </div>
                <br />
                <div class="container">
                    <textarea style="width:1100px; height:100px" maxlength="150">  </textarea>
                </div>
</section>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="cform" id="contact-form">
							...
							<form  action="mail_handler.php" method="post" enctype="text/plain"class="contactForm" >
							  ...
							  <div class="form-group">
								...
								<textarea class="form-control" id="message" name="message" rows="5" data-rule="required" data-msg="Please write something for us"></textarea>
								<div class="validation"></div>
							  </div>
			...
			<div class="row animated opacity mar-bot20" data-andown="fadeIn" data-animation="animation">
				<div class="col-sm-12 align-center">
                    <ul class="social-network social-circle">
                        <li><a href="https://www.google.com" class="icoRss" title="Rss"><i class="fa fa-rss"></i></a></li>
