...
if(isset($_POST['signup']))
{
    ...
    $query="insert into register(emailid,userid,name,password) values ('$emailid','$userid','$name','$pass')";
    if(mysql_query($query))
    {
        echo"<h3>you have successfully registred</h3>";
    }
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						...
						<input class="input100" type="text" name="email" placeholder="Email addess..." id="emailid">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<input class="input100" type="text" name="pass" placeholder="*************" id="pass">
						<span class="focus-input100"></span>
					</div>
